...
class OnboardingContainerViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page1 = OnboardingViewController(heroImageName: "delorean", titleText: "Bankey is faster, easier to use, and has a brand new look and feel that will make you feel liek you are back in 1989.")
    ...
    private func layout(){
        ...
        NSLayoutConstraint.activate([
            ...
            doneBtn.bottomAnchor.constraint(equalToSystemSpacingBelow: view.bottomAnchor, multiplier: 2),
            doneBtn.heightAnchor.constraint(equalToConstant: 200)
        ])
